...
Процедура ОкрытьАнализГрафика(Команда)
    ...
    ОткрытьФорму("Документ.ВКМ_ГрафикОтпусков.Форма.АнализГрафика", Новый Структура("АдресДанных", АдресВоВременномХранилище), ЭтаФорма);
...
Функция ПодготовитьДанныеДляАнализаНаСервере()
    ...
    Возврат ПоместитьВоВременноеХранилище(ДанныеДляДиаграммы, УникальныйИдентификатор);
